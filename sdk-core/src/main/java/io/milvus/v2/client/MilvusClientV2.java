...
public class MilvusClientV2 {
    ...
    public void updateReplicateConfiguration(UpdateReplicateConfigurationReq request) {
        rpcUtils.retry(()->cdcService.updateReplicateConfiguration(this.getRpcStub(), request));
    }
